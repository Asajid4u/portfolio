...
export default function Navbar() {
  ...
  return (
    <nav className="absolute top-0 left-0 w-full z-50">
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 py-6 md:py-10 flex items-center justify-between">
      ...
      {/* Mobile Dropdown */}
      {open && (
        <div className="md:hidden bg-[#0a0f1e]/95 backdrop-blur-lg border-t border-white/10 px-6 pb-6">
