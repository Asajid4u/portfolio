...
//           className="bg-white/5 backdrop-blur-md border border-white/10 p-10 rounded-3xl space-y-6 relative left-50 bottom-20"
//         >
...
export default function ContactSection() {
  ...
  return (
    <section className="max-w-6xl w-full mx-auto ">
      ...
      {/* Heading */}
      <div className="text-center mr-80 mb-20">
        <p className="text-blue-400 text-sm tracking-wider">
          Get in Touch
        </p>
        <h2 className="text-4xl font-bold">
