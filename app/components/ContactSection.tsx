  ...
  return (
    <section className="max-w-6xl w-full mx-auto px-6 py-20">
      ...
      <div className="text-center mb-16">
        <p className="text-blue-400 text-sm tracking-wider uppercase">
          Get in Touch
        </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
        ...
        <div className="space-y-8">
          <div className="flex items-start gap-5">
            <div className="bg-blue-500 p-4 rounded-full shrink-0">
              <FaEnvelope />
            </div>
            <div>
              <h4 className="font-semibold text-lg">Email</h4>
        ...
        <form
          onSubmit={handleSubmit}
          className="bg-white/5 backdrop-blur-md border border-white/10 p-6 sm:p-10 rounded-3xl space-y-6"
        >
          <div>
            <label className="block mb-2 text-sm text-gray-300">
              Your Name
          ...
          <button
            type="submit"
            className="w-full sm:w-auto bg-blue-500 hover:bg-blue-600 px-8 py-3 rounded-full font-medium transition shadow-lg shadow-blue-500/30"
          >
            Send Message
          </button>
        </form>
